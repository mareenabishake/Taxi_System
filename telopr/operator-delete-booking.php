  ...
  if(isset($_POST['delete_booking']))
    {
            ...
            $query="update tms_user set u_car_type=?, u_car_regno=?, u_car_driver=?, u_car_driver_contact=?, u_car_bookdate=?, u_car_pickup=?, u_car_drop=?, u_car_hire=?, u_car_book_status=? where u_id=?";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('sssssssssi',  $u_car_type, $u_car_regno, $u_car_driver, $u_car_driver_contact, $u_car_bookdate, $u_car_pickup, $u_car_drop, $u_car_hire, $u_car_book_status, $u_id);
            $stmt->execute();
                if($stmt)
                {
        ...
        ?>
            ...
            <div class=" form-group">
                             ...
                             <div class="form-group">
                                 ...
                                 <input type="text" readonly placeholder="<?php echo $row->u_car_book_status;?>" class="form-control" id="Booking Status" name="u_car_book_status">
                             </div>
