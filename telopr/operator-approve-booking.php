        ...
        ?>
            ...
            <div class=" form-group">
                             ...
                             <div class="form-group">
                                 ...
                                 <input type="email" readonly value="<?php echo $row->u_car_driver;?>" class="form-control" name="u_car_driver">
                             </div>

                             <div class="form-group">
                                 <label for="Driver Contact No">Driver Contact No</label>
                                 <input type="email" readonly value="<?php echo $row->u_car_driver_contact;?>" class="form-control" name="u_car_driver_contact">
                             </div>


                             <div class="form-group">
                                 <label for="Booking Date">Booking Date</label>
                                 <input type="text" readonly value="<?php echo $row->u_car_bookdate;?>" class="form-control" id="Booking Date" name="u_car_bookdate">
                             </div>
