...
if (isset($_POST['user_login'])) {
    ...
    if ($stmt->num_rows > 0) {
        ...
        $error = "Incorrect email or password."; // Set error message for incorrect credentials
    }
...
<head>
    ...
    <title>City Taxi- Client Login</title>
...
<body class="bg-dark">
    ...
    <div class="container">
        <div class="card card-login mx-auto mt-5">
            <div class="card-header">Login For Client</div>
            <div class="card-body">
