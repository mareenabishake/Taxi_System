 <ul class="sidebar navbar-nav">
     ...
     <li class="nav-item dropdown">
         <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
             ...
             <span>Telephone Operator</span>
         </a>
         <div class="dropdown-menu" aria-labelledby="pagesDropdown">

             <a class="dropdown-item" href="admin-add-operator.php">Add</a>
             <a class="dropdown-item" href="admin-view-operator.php">View</a>
             <a class="dropdown-item" href="admin-manage-operator.php">Manage</a>
         </div>
     </li>
